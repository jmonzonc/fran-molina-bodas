...
const TARRAGONA_FAQS = [
  ...
  {
    question:
      "¿Cuáles son los mejores venues para bodas en Tarragona?",
    answer:
  ...
  {
    question:
      "¿Necesito permisos especiales para fotos de boda en Tarragona?",
    answer:
  ...
  {
    question:
      "¿Cuáles son las mejores horas de luz para fotos de boda en Tarragona?",
    answer:
    ...
    <>
      ...
      <main itemScope itemType="https://schema.org/WebPage">
        ...
        <section className="relative h-[70vh] w-full overflow-hidden">
          <Image
            src={TARRAGONA_PORTFOLIO[0].image}
            alt="Fotógrafo de bodas en Tarragona — Fran Molina"
            fill
          ...
          <header className="absolute inset-0 flex items-center justify-center">
            <div className="max-w-4xl mx-auto px-6 text-center">
              ...
              <p className="text-xl md:text-2xl text-[#d4a574]/90 font-medium mb-10">
                ...
                con alma mediterránea en la Costa Daurada
              </p>
              <a
                href="#contacto-tarragona"
        ...
        <section className="py-20 bg-background">
          <div className="max-w-3xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-serif text-primary mb-8 text-center">
              Tu boda en Tarragona, contada con emoción
            </h2>
            <div className="space-y-6 text-muted-foreground text-lg leading-relaxed">
              <p>
                Tarragona y la Costa Daurada son el escenario perfecto para una
                boda mediterránea. Masías centenarias entre viñedos, playas
                doradas, ruinas romanas con siglos de historia… Cada rincón de
                esta tierra ofrece una luz y una atmósfera únicas. Como{" "}
                <strong>fotógrafo de bodas en Tarragona</strong>, llevo más de{" "}
                {new Date().getFullYear() - BUSINESS_INFO.foundedYear} años
                capturando la esencia de cada pareja con un estilo natural,
                cinematográfico y cuidado hasta el último detalle.
              </p>
              <p>
                Conozco los mejores venues de Tarragona, Reus, Salou, Cambrils y
                toda la Costa Daurada. Sé a qué hora la luz baña el Anfiteatro
                Romano, en qué rincón del Bosque de la Marquesa se filtra el sol
                entre las hojas, y cómo aprovechar cada minuto del atardecer en
                la playa Larga. Ese conocimiento local marca la diferencia en
                tus fotos.
              </p>
              <p>
                Trabajo con parejas que buscan un reportaje auténtico, sin poses
                forzadas, donde la emoción y la complicidad sean las
        ...
        <section className="py-20 px-6 bg-secondary/10">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-serif text-center mb-16 text-primary">
              Bodas en Tarragona y Costa Daurada
            </h2>
        ...
        <section className="py-20 bg-gradient-to-b from-secondary/20 to-transparent">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-4xl md:text-5xl font-serif text-primary mb-4 text-center">
              Servicios de Fotografía de Bodas en Tarragona
            </h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto text-center mb-16">
              Cobertura completa en Tarragona, Reus, Salou, Cambrils, Valls y
              toda la Costa Daurada sin coste adicional de desplazamiento.
            </p>
        ...
        <section
          ...
          aria-label="Preguntas frecuentes sobre fotografía de bodas en Tarragona"
        >
          <div className="max-w-3xl mx-auto px-6">
            <h2 className="text-4xl md:text-5xl font-serif text-primary mb-4 text-center">
              Preguntas Frecuentes — Bodas en Tarragona
            </h2>
            <p className="text-muted-foreground text-lg text-center mb-12">
              Todo lo que necesitas saber sobre contratar un fotógrafo de bodas
        ...
        >
          <div className="max-w-lg mx-auto px-6 text-center">
            ...
            <a
              ...
              aria-label="Contactar por WhatsApp para boda en Tarragona"
            >
            ...
            <p className="mt-6 text-white/50 text-sm">
              o llámame al{" "}
              <a
                href={PHONE_DISPLAY.replace(/\s/g, "").replace("+", "tel:+")}
