    ...
    >
      <div className="max-w-lg mx-auto px-6">
        ...
        >
          ...
          <div>
            <label htmlFor="contact-email" className="sr-only">Tu correo electrónico</label>
            <input
              id="contact-email"
              type="email"
          ...
          <div>
            <label htmlFor="contact-date" className="sr-only">Fecha de tu boda</label>
            <input
              id="contact-date"
              type="date"
          ...
          <div>
            <label htmlFor="contact-message" className="sr-only">Cuéntanos sobre tu boda</label>
            <textarea
              id="contact-message"
        ...
        <p className="mt-6 text-center text-white/50 text-sm">o también puedes</p>
