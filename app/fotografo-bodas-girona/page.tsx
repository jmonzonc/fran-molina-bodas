...
const breadcrumbSchema = {
  ...
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "Inicio", item: SITE_URL },
    {
      "@type": "ListItem",
      position: 2,
      name: "Fotógrafo de Bodas en Girona",
      item: `${SITE_URL}/fotografo-bodas-girona`,
    },
  ],
}
    ...
    <>
      ...
      <main itemScope itemType="https://schema.org/WebPage">
        <section className="relative h-[70vh] w-full overflow-hidden">
          <Image src={GIRONA_PORTFOLIO[0].image} alt="Fotógrafo de bodas en Girona — Fran Molina" fill className="object-cover" priority sizes="100vw" />
          <div className="absolute inset-0 bg-gradient-to-b from-black/30 via-black/50 to-black/70" />
          <header className="absolute inset-0 flex items-center justify-center">
            <div className="max-w-4xl mx-auto px-6 text-center">
              <h1 className="text-4xl md:text-6xl xl:text-7xl font-serif text-white/95 leading-[1.1] mb-6 drop-shadow-2xl text-balance">Fotógrafo de Bodas en Girona</h1>
              <p className="text-xl md:text-2xl text-[#d4a574]/90 font-medium mb-10">
                <strong>{BUSINESS_INFO.shortName}</strong> — Reportajes de boda entre masías, bosques y la Costa Brava
              </p>
              <a href="#contacto-girona" className="inline-block bg-[#d4a574] hover:bg-[#d4a574]/90 text-[#1a365d] px-10 py-5 rounded-2xl text-xl font-semibold shadow-2xl hover:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] transition-all duration-300 uppercase tracking-wide">Pide presupuesto</a>
            </div>
          </header>
        </section>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-3xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-serif text-primary mb-8 text-center">Tu boda en Girona, contada con emoción</h2>
            <div className="space-y-6 text-muted-foreground text-lg leading-relaxed">
              <p>Girona y la Costa Brava son un paraíso para las bodas: masías centenarias rodeadas de bosques, calas de aguas turquesas, pueblos medievales con siglos de historia y una luz que solo existe en el Empordà. Como <strong>fotógrafo de bodas en Girona</strong>, llevo más de {new Date().getFullYear() - BUSINESS_INFO.foundedYear} años capturando la magia de cada celebración con un estilo natural, cinematográfico y lleno de emoción.</p>
              <p>He fotografiado bodas en masías como Can Riera de la Pineda, en venues con vistas al mar en Begur y Cadaqués, y en el casco antiguo de Girona con la Catedral como telón de fondo. Ese conocimiento de la zona — saber dónde cae la luz a cada hora, qué rincones son los más fotogénicos — marca la diferencia en tus fotos.</p>
              <p>Trabajo con parejas que buscan un reportaje auténtico, sin poses forzadas, donde la complicidad y la emoción sean las protagonistas. Desde los preparativos hasta el último baile, estaré ahí para inmortalizar cada instante.</p>
            </div>
        ...
        <section className="py-20 px-6 bg-secondary/10">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-serif text-center mb-16 text-primary">Bodas en Girona y Costa Brava</h2>
        ...
        <section className="py-20 bg-gradient-to-b from-secondary/20 to-transparent">
          <div className="max-w-4xl mx-auto px-6">
            <h2 className="text-4xl md:text-5xl font-serif text-primary mb-4 text-center">Servicios de Fotografía de Bodas en Girona</h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto text-center mb-16">Cobertura en Girona, Costa Brava, Empordà, Garrotxa y toda la provincia sin coste de desplazamiento.</p>
            <div className="space-y-8">
              <article className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
                <h3 className="text-2xl font-serif text-primary mb-3">Preboda en Girona</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">Sesiones de pareja en los rincones más especiales de Girona: el Barri Vell con el río Onyar, los jardines de la Devesa, calas escondidas de Begur o masías del Empordà. 2-3 horas con más de 50 fotos editadas. <strong>Desde 400 €.</strong></p>
              ...
              <article className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
                <h3 className="text-2xl font-serif text-primary mb-3">Boda Completa en Girona</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">Cobertura completa del día de vuestra boda en masías del Empordà como Can Riera de la Pineda, Mas Torroella o Castell d'Empordà, o en venues frente al mar de la Costa Brava. Fotografía y vídeo cinematográfico con más de 400 fotos editadas y highlight reel. <strong>Desde 2.200 €.</strong></p>
                <Link href="/#servicios" className="text-accent hover:text-accent/80 font-medium underline underline-offset-4 transition-colors">Ver detalles completos →</Link>
              </article>
              <article className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
        ...
        <section className="py-24 bg-background" aria-label="Preguntas frecuentes sobre fotografía de bodas en Girona">
          <div className="max-w-3xl mx-auto px-6">
            <h2 className="text-4xl md:text-5xl font-serif text-primary mb-4 text-center">Preguntas Frecuentes — Bodas en Girona</h2>
            <p className="text-muted-foreground text-lg text-center mb-12">Todo lo que necesitas saber sobre contratar un fotógrafo de bodas en Girona y la Costa Brava</p>
        ...
        <section id="contacto-girona" className="py-24 bg-gradient-to-b from-[#111827] to-gray-900">
          <div className="max-w-lg mx-auto px-6 text-center">
            ...
            <a href={whatsappGirona} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white py-5 px-10 rounded-2xl text-xl font-semibold shadow-2xl hover:shadow-[0_25px_50px_-12px_rgba(34,197,94,0.4)] uppercase tracking-wide transition-all duration-300" aria-label="Contactar por WhatsApp para boda en Girona">
